...
<p>このサイトは東京大学で行われている<a href="https://sites.google.com/g.ecc.u-tokyo.ac.jp/utokyo-project-sprint/" target="_blank">Utokyo Project Sprint</a>のプロジェクトに参加しているサービスです。
新型コロナウイルスによって生じた困難をネットサービスで解決または改善を目的としているプロジェクトです。</p>
</section>

<section>
<a name="link2service" id="home_link2service"><h2>Service</h2></a>
<p>新型コロナウイルスの影響で、在宅勤務や休校などで多くの人が外出自粛を余儀無くされています。
この自粛期間で運動不足になっている人は多くいると思います。例えば、学生なら部活動やサークルに行くことができない、社会人ならスポーツジムに行くことができない、
プロスポーツ選手でさえ練習することができません。<br>
また人と直接合う機会が減ったことで、孤立感を感じる方も多くいると思います。これらのような問題によって生じる身体面、精神面での問題は非常に深刻なことであると考えました。<br>
そこで私たちは、自宅にいながら人と一緒に、気軽に運動できるサービスを開発しようと考えました。自宅できる運動は筋トレ、ストレッチなどさまざまあると思いますが、私たちは老若男女の誰もが知っているラジオ体操に焦点を当てました。<br>
多くの人は、学校の体育の授業で友達とラジオ体操を一緒にやった、または町内会で行われている朝の体操で町の人とラジオ体操を一緒にやった経験があると思います。
このようにラジオ体操は誰かと一緒にやる運動だと言えます。<br>
私たちはWeb上で他人とラジオ体操動画を共有して一緒にラジオ体操をするサービスを開発しました。
</p>
</section>

<section>
<a name="link2how2use" id="home_link2how2use"><h2>How to use</h2></a>
<p>初めて利用する方は、上のボタンより会員登録をお願いします。</p>
</section>
</section>
