<template>
  ...
  <!--
    <p>
      <input placeholder="URLを入力" v-model="videoUrl"></input>
    </p>
    ...
    <p>
      <input placeholder="飛ばしたい時間を入力(Enterで送信)" v-model="seconds" @keydown.enter.native="sendSeek"></input>
    </p>
    -->
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    fetch(){
      ...
      API.graphql(graphqlOperation(listMassages, { limit: 200 }))
